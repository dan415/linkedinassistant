...
def get_linkedin_id(access_token: str) -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info(f'Successfully retrieved LinkedIn ID')
...
def linkedin_authentication() -> str:
    ...
    :return: Rendered authentication HTML page.
    """
    logger.info(f'Serving authentication page')
...
def callback() -> Tuple[str, int]:
    ...
    params = {
        ...
        'client_secret': vault_client.get_secret(SecretKeys.LINKEDIN_CLIENT_SECRET)
    }
    ...
    vault_client.create_or_update_secret(SecretKeys.LINKEDIN_ACCESS_TOKEN, access_token)
