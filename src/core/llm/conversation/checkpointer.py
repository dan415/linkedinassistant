...
class MongoDBSaver(BaseCheckpointSaver):
    ...
    def clear(self, thread_id: str) -> None:
        """Clear all checkpoints related to the specified thread ID.
    ...
    def list(
        ...
        Args:
            ...
            additional_filter (Optional[Dict[str, Any]]): Additional filtering criteria for metadata. Defaults to None.
            before (Optional[RunnableConfig]): If provided, only checkpoints before the specified checkpoint ID
